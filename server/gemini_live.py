                            ...
                            if tool_call:
                                ...
                                for fc in tool_call.function_calls:
                                    ...
                                    if func_name in self.tool_mapping:
                                        ...
                                        # result is now a dict: {"answer": str, "provenance": dict (optional)}
                                        answer_str = result.get("answer", str(result)) if isinstance(result, dict) else str(result)
                                        
                                        # Emit provenance event to frontend if available
                                        ...
                                        await event_queue.put({"type": "tool_call", "name": func_name, "args": args, "result": answer_str})
                                    else:
